...
- 集成 API 见 `docs/integration.md`（含两种接入模式、SDK 两形态、adapter 秘钥播种 `PB_SEED_KEYS`/`PB_DEV_KEYS`、证据快照服务、订单七类 goto/mission/announce/pause/resume/abort/ptz 与 `dock:true` 语义）；部署运维见 `docs/deploy.md`。
