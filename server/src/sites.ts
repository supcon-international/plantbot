...
const plant07: SiteDef = {
  ...
  cameras: [
    {
      id: 'perimeter-cam',
      name: 'Recorded · Process pipework',
      place: 'Oil/chemical plant inspection point',
      stream: 'perimeter-cam',
      file: media('perimeter.mp4'),
      live: false,
      source: 'InspecSafe-V1 · CC BY 4.0 · Recorded / 录像',
    },
    {
      id: 'workshop-cam',
      name: 'Recorded · Conveyor corridor',
      place: 'Suspended inspection robot viewpoint',
      stream: 'workshop-cam',
    ...
    {
      id: 'mast-cam',
      name: 'Recorded · High-voltage equipment',
      place: 'Substation inspection point',
      stream: 'mast-cam',
  ...
  ruleSeeds: [
    { name: 'Unbadged person in substation', model: 'person', kind: 'onboard-cv', source: 'spot07-front', sourceName: 'SPOT·A · Recorded switchgear', zone: 'Substation bay S-1', threshold: 0.7, severity: 'critical', robotId: 'ext-bd-91250107' },
    { name: 'Smoking behavior', model: 'smoking', kind: 'cloud-cv', source: 'workshop-cam', sourceName: 'Recorded · Conveyor corridor', zone: 'Robot staging area', threshold: 0.75, severity: 'critical' },
    { name: 'Stack thermal anomaly', model: 'thermal', kind: 'onboard-cv', source: 'spot07-therm', sourceName: 'SPOT·A · Recorded substation thermal', zone: 'Boiler stack, sector N', threshold: 0.65, severity: 'high', robotId: 'ext-bd-91250107' },
    { name: 'PPE compliance', model: 'ppe', kind: 'cloud-cv', source: 'workshop-cam', sourceName: 'Recorded · Conveyor corridor', zone: 'Robot staging area', threshold: 0.6, severity: 'info' },
    { name: 'Perimeter motion', model: 'motion', kind: 'sim', source: 'perimeter-cam', sourceName: 'Recorded · Process pipework', zone: 'North fence, waterline', threshold: 0.55, severity: 'low' },
    { name: 'ΔT ceiling — thermal imager', model: 'thermal', kind: 'threshold', source: 'spot07-therm', sourceName: 'SPOT·A · Recorded substation thermal', zone: 'Boiler stack, sector N', threshold: 1, severity: 'high', robotId: 'ext-bd-91250107', metric: 'dt.max.c', op: '>', bound: 14 },
  ],
  missionSeeds: [
    {
...
const plant12: SiteDef = {
  ...
  ruleSeeds: [
    { name: 'Tank row thermal anomaly', model: 'thermal', kind: 'onboard-cv', source: 'x30hb-therm', sourceName: 'X30·HB · Recorded conveyor thermal', zone: 'Tank row — ATEX', threshold: 0.65, severity: 'high', robotId: 'ext-x30-jy-2024-0007' },
    { name: 'Person on berth apron', model: 'person', kind: 'cloud-cv', source: 'berth-cam', sourceName: 'Recorded · Process pipework', zone: 'Berth — exclusion', threshold: 0.7, severity: 'critical' },
    { name: 'Berth motion watch', model: 'motion', kind: 'sim', source: 'berth-cam', sourceName: 'Recorded · Process pipework', zone: 'Berth — exclusion', threshold: 0.55, severity: 'low' },
    { name: 'Manifold gauge OCR', model: 'gauge', kind: 'onboard-cv', source: 'x30hb-optical', sourceName: 'X30·HB · Recorded high-voltage equipment', zone: 'Manifold skid', threshold: 0.6, severity: 'info', robotId: 'ext-x30-jy-2024-0007' },
    { name: 'Night watch — tank row', model: 'motion', kind: 'sim', source: 'tankrow-cam', sourceName: 'Recorded · Process valves', zone: 'Tank row — ATEX', threshold: 0.55, severity: 'low' },
...
const campus: SiteDef = {
  ...
  cameras: [
    {
      id: 'gate-cam',
      name: 'Recorded · Campus parking',
      place: 'Facility grounds, fixed camera recording',
      stream: 'gate-cam',
      file: media('campus_gate.mp4'),
      live: false,
      source: 'MEVA · CC BY 4.0 · Recorded / 录像',
    },
    {
      id: 'perimeter-cam-c',
      name: 'Recorded · Facility stairs',
      place: 'Indoor stairway, fixed camera recording',
    ...
    {
      id: 'stadium-cam',
      name: 'Recorded · Parking overview',
      place: 'Facility grounds, fixed camera recording',
      stream: 'stadium-cam',
    ...
    {
      id: 'lot-cam',
      name: 'Recorded · Parking activity',
      place: 'Facility grounds, fixed camera recording',
      stream: 'lot-cam',
  ...
  ruleSeeds: [
    { name: 'Perimeter crossing at night', model: 'person', kind: 'onboard-cv', source: 'x30ce-optical', sourceName: 'X30·CE · Recorded facility stairs', zone: 'North fence — restricted', threshold: 0.7, severity: 'critical', robotId: 'ext-x30-jy-2024-0031' },
    { name: 'Unattended bag — gate', model: 'unattended-bag', kind: 'cloud-cv', source: 'gate-cam', sourceName: 'Recorded · Campus parking', zone: 'Main gate check', threshold: 0.6, severity: 'high' },
    { name: 'Crowding — canteen rush', model: 'crowding', kind: 'cloud-cv', source: 'spotce-front', sourceName: 'SPOT·CE · Recorded parking', zone: 'Canteen plaza', threshold: 0.55, severity: 'info', robotId: 'ext-bd-91250203' },
    { name: 'Fall detection — walkways', model: 'fall', kind: 'onboard-cv', source: 'perimeter-cam-c', sourceName: 'Recorded · Facility stairs', zone: 'Main walk', threshold: 0.65, severity: 'high' },
    { name: 'E-bike in fire lane', model: 'ebike-blocking', kind: 'cloud-cv', source: 'lot-cam', sourceName: 'Recorded · Parking activity', zone: 'Fire lane — keep clear', threshold: 0.6, severity: 'high' },
    { name: 'Tailgating at gate', model: 'tailgating', kind: 'onboard-cv', source: 'gate-cam', sourceName: 'Recorded · Campus parking', zone: 'Main gate check', threshold: 0.65, severity: 'high' },
    { name: 'After-hours motion — stadium', model: 'motion', kind: 'sim', source: 'stadium-cam', sourceName: 'Recorded · Parking overview', zone: 'Stadium gate', threshold: 0.55, severity: 'low' },
